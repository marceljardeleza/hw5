...
## 1) trying to zoom, but doesnt show map details like county name
  ggplot() +
  geom_sf(data = co_counties) +
  geom_sf(data= co_data_coord, aes(color = disposition,
                                   shape = victim_race)) +
...
## 2) cropping the data directly, but still not showing the roads and city boundaries and names
